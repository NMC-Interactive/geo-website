...
const TRANSLATIONS: Record<string, Record<Lang, string | string[]>> = {
  ...
  // Terminal
  'terminal.header': { en: '$ AURA_CONTENT_DISCOVERY_PROTOCOL', zh: '$ AURA_内容发现协议' },
  ...
  'footer.email': { en: 'hello@aura.geo', zh: 'hello@aura.geo' },
  'footer.location': { en: 'San Francisco, CA', zh: '加利福尼亚州旧金山' },
  'footer.col.platform': { en: 'Platform', zh: '平台' },
