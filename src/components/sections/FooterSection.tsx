    ...
    <footer id="footer" ref={sectionRef} className="relative" style={{ background: '#050505', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
      <div className="px-8 py-24 md:px-12">
        ...
        <div className="mt-8 flex items-center gap-6">
          <a
            href="mailto:contact@nmc-interactive.com"
      ...
      >
        <div className="flex flex-col items-start leading-none">
          <span className="font-display text-[#A0A0A0]" style={{ fontSize: '0.8rem', letterSpacing: '0.06em', fontWeight: 700, lineHeight: 1.1 }}>
            {t('footer.contact.line2') as string}
          </span>
          <span className="font-serif italic" style={{ fontSize: '0.55rem', color: '#666666', letterSpacing: '0.04em', lineHeight: 1.3, marginTop: '1px' }}>
            {t('footer.contact.byline') as string}
          </span>
        </div>
