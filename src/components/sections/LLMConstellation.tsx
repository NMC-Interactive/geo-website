...
const LLM_NODES: LLMNode[] = [
  { id: 'gpt4o', name: 'ChatGPT', company: 'OpenAI', region: 'WEST', x: 0.78, y: 0.22, radius: 18, color: '#10A37F', glowColor: 'rgba(16,163,127,0.4)' },
  ...
  { id: 'llama', name: 'Llama', company: 'Meta', region: 'WEST', x: 0.85, y: 0.55, radius: 15, color: '#0668E1', glowColor: 'rgba(6,104,225,0.4)' },
  ...
  { id: 'deepseek', name: 'DeepSeek', company: 'DeepSeek', region: 'EAST', x: 0.22, y: 0.18, radius: 18, color: '#4F46E5', glowColor: 'rgba(79,70,229,0.5)' },
  { id: 'kimi', name: 'Kimi Agent', company: 'Moonshot', region: 'EAST', x: 0.10, y: 0.32, radius: 16, color: '#3B82F6', glowColor: 'rgba(59,130,246,0.5)' },
  { id: 'qwen', name: 'Qwen', company: 'Alibaba', region: 'EAST', x: 0.28, y: 0.40, radius: 17, color: '#FF6A00', glowColor: 'rgba(255,106,0,0.5)' },
  { id: 'ernie', name: 'Ernie', company: 'Baidu', region: 'EAST', x: 0.12, y: 0.50, radius: 15, color: '#2932E1', glowColor: 'rgba(41,50,225,0.5)' },
  ...
  { id: 'glm', name: 'GLM', company: 'Zhipu AI', region: 'EAST', x: 0.20, y: 0.78, radius: 13, color: '#E53935', glowColor: 'rgba(229,57,53,0.5)' },
  { id: 'yi', name: 'Yi-Large', company: '01.AI', region: 'EAST', x: 0.35, y: 0.72, radius: 12, color: '#7C4DFF', glowColor: 'rgba(124,77,255,0.5)' },
  { id: 'baichuan', name: 'Baichuan', company: 'Baichuan', region: 'EAST', x: 0.15, y: 0.88, radius: 12, color: '#FF9800', glowColor: 'rgba(255,152,0,0.5)' },
  ...
  useEffect(() => {
    ...
    const ro = new ResizeObserver((entries) => {
      for (const entry of entries) {
        ...
        setDimensions({ width: Math.floor(width * dpr), height: Math.floor(height * dpr) })
      }
    })
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      LLM_NODES.forEach((node) => {
        ...
        if (isHovered && !foundHover) foundHover = node
  ...
  return (
    <div className="relative w-full" style={{ maxWidth: '500px' }}>
      <canvas
        ...
        style={{ width: '100%', aspectRatio: '1 / 1', cursor: 'crosshair', display: 'block' }}
      />
      ...
      <div className="mt-3 flex items-center justify-center gap-6 font-mono text-xs" style={{ color: '#666666', letterSpacing: '0.08em' }}>
